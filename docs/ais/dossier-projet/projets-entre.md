...
3. Gestion de projet (planning et suivi, environnement humain et technique, objectifs de qualité) :
...
4. Argumentation du choix des solutions retenues en précisant les critères et les méthodes de sélection :
...
3. Gestion de projet (planning et suivi, environnement humain et technique, objectifs de qualité) :
	...
	- Tests sur un serveur de <font color="#92d050">test</font> ;
...
## <font color="#ffc000">Projet 3 : ?</font>
...
## <font color="#92d050">Projet 4 : ESP Québec</font>
